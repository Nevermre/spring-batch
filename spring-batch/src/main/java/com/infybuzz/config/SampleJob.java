...
public class SampleJob {
	...
	public FlatFileItemReader<StudentCsv> flatFileItemReader(
		...
		flatFileItemReader.setResource(fileSystemResource);
		  ...
		  setNames("ID","First Name","Last Name","Email"); } }); setFieldSetMapper(new
		  BeanWrapperFieldSetMapper<StudentCsv>() { { setTargetType(StudentCsv.class);
		  } }); } });
	 ...
	 * ItemWriterAdapter<StudentCsv> itemWriterAdapter = new
	 * ItemWriterAdapter<StudentCsv>();
	 * itemWriterAdapter.setTargetObject(studentService);
	 * itemWriterAdapter.setTargetMethod("restCallToCreateStudent"); return
	 * itemWriterAdapter; }
	 */
	 ...
	 * itemReaderAdapter.setArguments(new Object[] {1L,"teste"}); return
	 * itemReaderAdapter; }
	 */
//	private Step firstChunkStep() {
//		return stepBuilderFactory.get("Second Step")
